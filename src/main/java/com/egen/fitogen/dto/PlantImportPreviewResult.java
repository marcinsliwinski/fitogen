...
public class PlantImportPreviewResult {
    ...
    public PlantImportPreviewResult(
            String sourceName,
            char delimiter,
            List<String> resolvedHeaders,
            List<PlantImportPreviewRow> rows,
            int newRowsCount,
    ...
    public List<PlantImportPreviewRow> getRows() {
    ...
    public boolean hasIssues() {
        return duplicateInFileCount > 0 || invalidRowsCount > 0;
    }
}