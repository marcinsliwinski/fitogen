...
public class ContrahentImportPreviewResult {
    ...
    public ContrahentImportPreviewResult(String sourceName, char delimiter, List<String> resolvedHeaders,
                                         List<ContrahentImportPreviewRow> rows, int newRowsCount,
    ...
    public List<ContrahentImportPreviewRow> getRows() { return rows; }
