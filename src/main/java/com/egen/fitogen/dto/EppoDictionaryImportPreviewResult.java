...
public class EppoDictionaryImportPreviewResult {
    private final String sourceName;
    private final char delimiter;
    private final List<String> resolvedHeaders;
    private final List<EppoDictionaryImportPreviewRow> rows;
    ...
    public EppoDictionaryImportPreviewResult(
            String sourceName,
            char delimiter,
            List<String> resolvedHeaders,
            List<EppoDictionaryImportPreviewRow> rows,
            int newRowsCount,
            int updateRowsCount,
    ...
    public List<EppoDictionaryImportPreviewRow> getRows() { return rows; }
    public int getNewRowsCount() { return newRowsCount; }
    public int getUpdateRowsCount() { return updateRowsCount; }
    ...
    public int getImportableRowsCount() { return newRowsCount + updateRowsCount; }
