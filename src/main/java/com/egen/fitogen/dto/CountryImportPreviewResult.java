...
public class CountryImportPreviewResult {
    private final String sourceName;
    private final char delimiter;
    private final List<String> resolvedHeaders;
    private final List<CountryImportPreviewRow> rows;
    ...
    public CountryImportPreviewResult(String sourceName,
                                      char delimiter,
                                      List<String> resolvedHeaders,
                                      List<CountryImportPreviewRow> rows,
                                      int newRowsCount,
                                      int updateRowsCount,
    ...
    public List<CountryImportPreviewRow> getRows() {
        return rows;
    }
